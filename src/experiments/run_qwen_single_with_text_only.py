...
def answer_text_only(model, processor):
    messages = [
        {
            "role": "user",
...
def main():
    ...
    text_only_raw, text_only_answer = answer_text_only(model, processor)

    report["methods"]["text_only"] = {
        "frame_paths": [],
        "selected_timestamps": [],
        "raw_answer": text_only_raw,
        "parsed_answer": text_only_answer,
        "is_correct": text_only_answer == CORRECT_ANSWER,
    }

    print(
        f"text_only: raw={text_only_raw!r}, "
        f"parsed={text_only_answer!r}, "
        f"correct={text_only_answer == CORRECT_ANSWER}"
    )
    ...
    output_path = RESULT_ROOT / "qwen_answers_with_text_only.json"
