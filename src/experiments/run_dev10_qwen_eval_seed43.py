...
SELECTION_ROOT = Path("results/dev10_selection_seed43_seed43")
OUTPUT_ROOT = Path("results/dev10_qwen_eval_seed43")
METHODS = ("text_only", "uniform", "random", "clip_topk", "qatss")
